...
<div class="row mt-2">
    <div class="col-sm mt-2 mt-md-0">
        {% include video.html path="https://www.youtube.com/watch?v=y3OoRu5GX3M" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row mt-2">
    <div class="col-sm mt-2 mt-md-0">
        {% include video.html path="https://www.youtube.com/watch?v=D5zXVeOPy30" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
